...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "ismael.lardom@gmail.com",
    href: "mailto:ismael.lardom@gmail.com",
  },
  {
    icon: MapPin,
    label: "Location",
                ...
                <div
                  className={`flex items-center gap-3 p-4 rounded-xl ${
                    isSubmitting.type === "success"
                      ? "bg-green-50/10 border border-green-500/20 text-green-400"
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                I'm actively seeking new opportunities and collaborations. If
                you have a project in mind or want to discuss how we can work
